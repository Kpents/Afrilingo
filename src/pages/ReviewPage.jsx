...
export default function ReviewPage({ dark, progress, language, soundEnabled, onLoseHeart, onComplete }) {
  ...
  if (session && items.length) return <ReviewSession dark={dark} items={items} hearts={progress.hearts} languageId={language.id} soundEnabled={soundEnabled} onLoseHeart={onLoseHeart} onExit={() => setSession(false)} onComplete={(result) => { onComplete(result); setSession(false); }} />;
